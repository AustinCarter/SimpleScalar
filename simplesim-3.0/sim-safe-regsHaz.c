...
sim_reg_stats(struct stat_sdb_t *sdb)
{
	...
	stat_reg_counter(sdb, "sim_num_cycles", "total number of cycles to execute", &cycles, cycles, NULL);
}
...
#define DEFINST(OP,MSK,NAME,OPFORM,RES,FLAGS,O1,O2,I1,I2,I3)		\
	case OP:														\
				...
				{						\
					if(index == 1)				\
					{							\
						cycles += 3;/*This instuction and the instuction after it must be moved to the next cycle (inorder execution)*/			\
